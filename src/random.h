...
#define QRS_X_DROUGHT_COEFF 1.05
#define QRS_S_DROUGHT_COEFF 1.05
#define QRS_Z_DROUGHT_COEFF 1.05
#define QRS_N_DROUGHT_COEFF 1.1
#define QRS_G_DROUGHT_COEFF 1.1
#define QRS_U_DROUGHT_COEFF 1.5
#define QRS_T_DROUGHT_COEFF 1.05
#define QRS_Fa_DROUGHT_COEFF 1.05
#define QRS_Fb_DROUGHT_COEFF 1.05
#define QRS_P_DROUGHT_COEFF 2.5
#define QRS_Q_DROUGHT_COEFF 2.5
#define QRS_W_DROUGHT_COEFF 1.05
#define QRS_Ya_DROUGHT_COEFF 1.05
#define QRS_Yb_DROUGHT_COEFF 1.05
#define QRS_V_DROUGHT_COEFF 1.05
