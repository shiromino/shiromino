...
#define QRS_Fa_WEIGHT 0.2L
#define QRS_Fb_WEIGHT 0.2L
...
#define QRS_L_DROUGHT_COEFF 2.0
#define QRS_J_DROUGHT_COEFF 2.0
#define QRS_N_DROUGHT_COEFF 1.5
#define QRS_G_DROUGHT_COEFF 1.5
#define QRS_U_DROUGHT_COEFF 2.0
#define QRS_P_DROUGHT_COEFF 4.0
#define QRS_Q_DROUGHT_COEFF 4.0

#define ARS_I_DROUGHT_COEFF 6.0
#define ARS_T_DROUGHT_COEFF 7.0
#define ARS_J_DROUGHT_COEFF 6.0
#define ARS_L_DROUGHT_COEFF 6.0
#define ARS_O_DROUGHT_COEFF 6.0
#define ARS_S_DROUGHT_COEFF 5.0
#define ARS_Z_DROUGHT_COEFF 5.0
